                    ...
                    (if (<> (car strokes1) (car strokes2))
                        ...
                        (begin
                            (while (< strokecount (car strokes1))
                                ...
                                (when (> (* L1 L2) 0) ; neither zero length
                                    ...
                                    (while (< (+ counter 1 inLap) L1)
                                        (let* (
                                            ...
                                            (if (equal? rev FALSE)
                                                (gimp-edit-blend inLayer BLEND-CUSTOM LAYER-MODE-NORMAL GRADIENT-LINEAR 100 0 REPEAT-NONE FALSE TRUE 3 0.2 TRUE x3 y3 xQ yQ)          
                                                (gimp-edit-blend inLayer BLEND-CUSTOM LAYER-MODE-NORMAL GRADIENT-LINEAR 100 0 REPEAT-NONE FALSE TRUE 3 0.2 TRUE xQ yQ x3 y3)          
                                            )
                                            ;(gimp-message "line154")
                                            (gimp-progress-update (/ counter L1))
                                        ) 
                                ...
                                (gimp-progress-update (/ strokecount (car strokes1)))
...
(script-fu-register "RMA_path_blend"
                    "Path Blend..."
                    "Fills the area between two paths with a gradient. \nfile:RMA_path_blend.scm"
                    "Rob Antonishen"
                    "Rob Antonishen"
                    "April 2012"
                    "RGB*, GREY*"
