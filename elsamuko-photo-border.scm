  ...
  (let*  (
    ...
    (define (script-fu-photo-border-helper aimg adraw ashift aradius border_distance)
      (let*  (
            ...
            (gimp-edit-bucket-fill soft_margin BUCKET-FILL-FG LAYER-MODE-NORMAL 100 0 FALSE 0 0)
            ...
            (gimp-edit-bucket-fill hard_margin BUCKET-FILL-FG LAYER-MODE-NORMAL 100 0 FALSE 0 0)
            (gimp-selection-none img)
...
(script-fu-register "elsamuko-photo-border"
        ...
        SF-OPTION       "Place"         '("Top" "Left" "Down" "Right")
        SF-ADJUSTMENT   "Shift %"       '(0 -50 50 1 10 0 0)
        SF-ADJUSTMENT   "Radius"        '(7 1 20 1 2 0 0)
        SF-ADJUSTMENT   "Border Distance %" '(12 -5 100 1 10 0 0)
)

(script-fu-menu-register "elsamuko-photo-border" "<Image>/Script-Fu/Decor")
