...
; 1.02 - 11/14/2020 - upgrade for Gimp 2.10.22 by karlhof26
;
; --------------------------------------------------------------------
;
...
(script-fu-register "script-fu-lab-sharpening"
            "<Toolbox>/Script-Fu/Photo/Sharpen/Luminocity Sharpen"
            "Sharpen images intelligently. Smart sharpen only sharpens images on the edges, where sharpening counts. Even areas are not sharpened, so noise levels are kept down when compared to normal unsharp mask. You may need to tweak the parameters for best results. \nfile:salonen-luminocity-sharpening.scm"
