...
;   - Changelog -
;
; - Updated for Gimp-2.10.22 by karlhof26 on 23/11/2020
; --------------------------------------------------------------------
;
...
;
        (gimp-image-insert-layer InImage SharpenLightsLayer 0 -1)
           (gimp-layer-set-mode SharpenLightsLayer LAYER-MODE-LIGHTEN-ONLY)
        ...
        (let*    (
            ...
            (gimp-image-insert-layer InImage SharpenShadowsLayer 0 -1)
            (gimp-layer-set-mode SharpenShadowsLayer LAYER-MODE-DARKEN-ONLY)
...
(script-fu-register
    ...
    "<Toolbox>/Script-Fu/Photo/Sharpen/Eg Separate Lights&Shadows Sharpen"
    "Separate Sharpening (Lights&Shadows) \nfile:egger-separate-sharpen.scm"
