...
(define (script-fu-quick-sketch     theImage
    ...
    (let* (
        ...
        (if (= layerGrey 0) (gimp-drawable-desaturate theLayer DESATURATE-LIGHTNESS))
        ...
        (gimp-layer-set-mode layerCopy 16) ; was 16 now difference
...
(script-fu-register "script-fu-quick-sketch"
            "<Toolbox>/Script-Fu/Artistic/Quick sketch 1..."
            "Create a sketch from a photo. \nfile:quick-sketch1.scm"
            "Harry Phillips"
            "Harry Phillips"
            "Sep. 9 2007"
            "*"
