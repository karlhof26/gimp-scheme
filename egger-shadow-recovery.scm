...
;
; Shadow Recovery script for GIMP 2.10.22
...
; --------------------------------------------------------------------
;   - Changelog -
; March 2021 - fixed for gimp 2.10.22
...
(define (script-fu-Eg-ShadowRecovery InImage InLayer InMethod InOpacity InFlatten)
    ...
    (let*    (
        ...
        (gimp-layer-set-mode CopyLayer LAYER-MODE-ADDITION)
...
;
        ...
        (let*    (
            (CopyMask (car (gimp-layer-create-mask CopyLayer ADD-MASK-WHITE)))
            (ShadowMask (car (gimp-layer-create-mask ShadowLayer ADD-MASK-WHITE)))
            )
        ...
        (gimp-layer-set-mode ShadowLayer LAYER-MODE-OVERLAY)
...
(script-fu-register "script-fu-Eg-ShadowRecovery"
    "<Toolbox>/Script-Fu/Photo/Enhancement/Eg Recover Shadows"
    "Lighten-up Shadows. \nfile:egger-shadow-recovery.scm"
