...
;
; Spaced H Guides script  for GIMP 2.10.18
;
; Tags: spaced horizontal guides
;
; Author statement:
;
; Creates Spaced Horizontal Guides
;
; --------------------------------------------------------------------
; Distributed by ...
; --------------------------------------------------------------------
...
(script-fu-register
    ...
    ;description
    "Create a series of horizontal guides with an even spacing. \nfile:JMB-Spaced-Guides.scm"
...
(script-fu-menu-register "script-fu-spaced-hguides" "<Toolbox>/Script-Fu/Setup/Guides")
