    ...
    (let* (
        ...
        (if (= rotation TRUE)
            (begin
                ...
                (gimp-image-insert-layer img layer-rota-interpol-none 0 0)
                ...
                (if (> opac-rota 0) ; si l'opacite est superieure a 0 (car il est inutile d'ajouter un calque que l'on ne veut pas voir)
                    (begin
                        ...
                        (gimp-image-insert-layer img layer-rota-interpol-opt 0 0)
                    )
                )
...
(script-fu-register
    ...
    "<Toolbox>/Script-Fu2/2D Isometric-Fu/03 - Isometric Roof (26.57 degrees)"
    "Rotate -/+ 26.57 degrees to help to make an isometric roof. \nfile:Isometric-Roof_02.scm"
    "Loïc Guyader (froGgy)"
    "Copyright"
    "01/2011"
    "" ;; types d'images supportes par le script
        ...
        SF-OPTION       "Interpolation"                '(_"Cubic" _"Linear" _"Sinc (Lanczos3)")
        SF-ADJUSTMENT   "Opacity"                      '(50 0 100 1 10 1 0)
        SF-TOGGLE       "Rotate -/+ 26.57 degrees:"    TRUE
        SF-OPTION       "Transform-direction"          '("TRANSFORM-BACKWARD" "TRANSFORM-FORWARD")
        SF-OPTION       "Interpolation"                '("Cubic" "Linear" "Sinc (Lanczos3)")
        SF-ADJUSTMENT   "Opacity"                      '(50 0 100 1 10 1 0)
        SF-TOGGLE       "Cut from alpha"               FALSE
