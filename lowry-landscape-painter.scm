...
(define (script-fu-land-paint  img drawable blur-rad merge-flag )
...
(script-fu-register "script-fu-land-paint"
    "<Toolbox>/Script-Fu/Artistic/Landscape Painter"
    "Add Darken Only layer and blur it. \nfile:lowry-landscape-painter.scm"
    "Mark Lowry"
