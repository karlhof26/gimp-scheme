...
Newest version can be downloaded from http://registry.gimp.org/ \nfile:elsamuko-slide-with-sprockets.scm"
                    ...
                    SF-STRING       "Text" "GC 400-8 KODAK"
                    SF-ADJUSTMENT   "DX1" '(82 0 126 1 3 0 1)
                    SF-ADJUSTMENT   "DX2" '(3 0 15 1 3 0 1)
                    SF-FONT         "Font" "Monospace Bold"
                    SF-ADJUSTMENT   "Number of first frame" '(18 0 36 1 3 0 1)
                    SF-ADJUSTMENT   "Sprocketholes till first frame" '(1 1 8 1 3 0 1)
                    SF-ADJUSTMENT   "First hole after x mm" '(1 -2.5 2.5 0.5 1 1 1)
                    SF-COLOR        "Sprocket Hole Color" '(0 0 0)
                    SF-COLOR        "Sprocket Hole Shade" '(237 156 0)
                    )
(script-fu-menu-register "elsamuko-sprocketholes" "<Toolbox>/Script-Fu/Decor")
