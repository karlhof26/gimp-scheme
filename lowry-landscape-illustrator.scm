...
(script-fu-register "script-fu-Land_illust"
        "<Toolbox>/Script-Fu/Artistic/Landscape Illustrator"
        "Similar to Landscape Painter, but with a bit of a sketch effect as well.  Over-sharpen, then add Darken Only layer and blur it. Generates a painted look to a
 landscape photo.  Sometimes provides an interesting
 effect on portraits and animal shots.\nfile:lowry-landscape-illustrator.scm"
        "Mark Lowry"
