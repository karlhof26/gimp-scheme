...
(define (mm1-vintage-look img
  ...
  (let* ((drawable-width (car (gimp-drawable-width drw)))
    ...
    ;Magenta Layer
    (set! magenta-layer (car (gimp-layer-new img drawable-width drawable-height RGB "Magenta" 100  LAYER-MODE-SCREEN)))
...
(script-fu-menu-register "mm1-vintage-look" "<Image>/Script-Fu/Artistic")
