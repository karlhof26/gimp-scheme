...
;    - Initial version
;  Version 0.2
;    - add starution and level min max..
;   Version 0.3
;    - add soft grow value
;    - add slide input
;  Version 0.4
;    - updated to work with GIMP-2.10.22
;  
; --------------------------------------------------------------------
;
    ...
    (let*  (
        ...
        (if (= modeOp 1)
            ...
            (begin
                ...
                ;Invert layer
                ;(gimp-invert merged)
                (gimp-drawable-invert merged FALSE)
            )
        )
...
(define (script-fu-fake-hdr-effect-plus inImage inDrawable softvalue1 softvalue2 softvalue3  lev3min Opa-num thin thick statunum lev5min lev5max)
...
(script-fu-register
    ...
    SF-ADJUSTMENT   "Level In Minimum"          '(100 0 255 1 1 0 0)
    SF-ADJUSTMENT   "Dark Layer Opacity"        '(35 30 50 1 1 0 0)
    SF-ADJUSTMENT   "Dodge Burn Thin"           '(10 0 500 1 1 0 0)
    SF-ADJUSTMENT   "Dodge Burn Thick"          '(25 0 500 1 1 0 0)
    SF-ADJUSTMENT   "Saturation"                '(50 -100 100 1 10 0 0)
    SF-ADJUSTMENT   "Level In Minimum"          '(25 0 255 1 1 0 0)
    SF-ADJUSTMENT   "Level In Maximum"          '(225 0 255 1 1 0 0)
)
