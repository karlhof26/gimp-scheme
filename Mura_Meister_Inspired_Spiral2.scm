...
(define (script-fu-mura-meister-inspired-spiral2
			image 
			layer 
			radius
			arclength
...
(script-fu-register
  "script-fu-mura-meister-inspired-spiral2"         ;function name of the function defined above
  "<Image>/Script-Fu2/Mura Meister/Mura Meister Inspired Spiral.2.."    ;menu register (where can this script be access from inside GIMP)
  "Mura Meister Inspired Spiral ver2 \nfile:Mura_Meister_Inspired_Spiral2.scm"       ;description
