...
;
; Version 1.0 - Updated for Gimp 2.10.18
  ...
  (let* (
    ...
    (while (< iterwidth itermaxX)
           (while (< iterheight itermaxY)
                  ...
                  (gimp-drawable-levels-stretch wblayer)
...
(script-fu-menu-register "elsamuko-wb-puzzle" "<Toolbox>/Script-Fu/Light and Shadow")
