                                ...
                                (begin
                                    ...
                                    (if (> Nb_couleurs_trouvees 0)
                                        (begin
                                            ...
                                            (if (= Noise TRUE)
                                                (begin
                                                    (plug-in-hsv-noise 1 image calque_8_couleurs (- 9 Nb_couleurs_trouvees) 5 170 10)
                                                )
                                            )
                                        )
                                    )
