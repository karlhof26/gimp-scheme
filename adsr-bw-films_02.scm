...
(define (adsr-bw-films-a image 
  ...
  (let* ( 
          ...
          (films '(("Agfa 200X"        18 41 41)
                  ...
                  ("Ilford Delta 400 Pro x 3200"  31 36 33)
                  ("Ilford FP4"       28 41 31)
                  ("Ilford HP5"       23 37 40)
                  ("Ilford Pan F"     33 38 31)
                  ("Ilford SFX"       36 31 33)
        ...
        (if (= oncopy TRUE)
            (begin
                ...
                (gimp-image-insert-layer image bw-layer 0 -1)
...
(script-fu-register "adsr-bw-films-a"
                    "Black and White Film"
                    "Desaturates the way various B and W films do. \n file: adsr-bw-films_02.scm "
                    ...
                    SF-OPTION    "Film"  '("Agfa 200X"
                                          "Agfapan 25"
                                          "Agfapan 100"
                                          "Agfapan 400"
                                          "Ilford Delta 100"
                                          "Ilford Delta 400"
                                          "Ilford Delta 400 Pro x 3200"
                                          "Ilford FP4"
                                          "Ilford HP5"
                                          "Ilford Pan F" 
                                          "Ilford SFX"
...
(script-fu-menu-register "adsr-bw-films-a"  "<Toolbox>/Script-Fu/Colors/")
