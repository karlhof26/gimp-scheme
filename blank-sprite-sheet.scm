...
(script-fu-register
    ...
    "<Image>/Script-Fu/Setup/Guides/Sprite Sheet Guides..."
    "Make guides for a sprite sheet.\nFor n sprites of height h and width w with spacing s between each.
       Makes guides for the above sprites. \nfile:blank-sprite-sheet.scm"
    "karlhof"
    "karlhof"
    "October 2020"
    ""
...
(script-fu-register
    ...
    "<Image>/Script-Fu/Setup/Blank Sprite Sheet..."
    "Make a new image for n sprites of a given size. Image is constrained to be a square, therefore end spaces are not strict the same as others. \nfile:blank-sprite-sheet.scm"
    "karlhof"
    "karlhof"
    "October 2020"
    ""
