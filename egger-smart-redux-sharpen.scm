...
;
; Smart Sharpening, Redux, V2.2 for GIMP 2.10.24
...
;
    (let* (
        ...
        ;
        (gimp-image-insert-layer InImage SharpenLayer 0 -1)
        ;
        ...
        ;
        (gimp-layer-set-mode SharpenLayer LAYER-MODE-HSV-VALUE)
        ;
...
(script-fu-register
    ...
    "<Toolbox>/Script-Fu/Photo/Sharpen/Eg Smart Redux Sharpen"
    "Smart Sharpening, Redux version \nfile:egger-smart-redux-sharpen.scm"
