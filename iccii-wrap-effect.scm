...
(define (script-fu-wrap-effect-b    inImage
                inDrawable
                inRadius
                inGamma1
                inGamma2
  ...
  (let* (
    ...
    (gimp-drawable-desaturate theNewlayer DESATURATE-LUMINANCE)
    ...
    (set! theLayermask (car (gimp-layer-create-mask theNewlayer ADD-MASK-BLACK)))
...
(script-fu-register
    "script-fu-wrap-effect-b"
    "<Toolbox>/Script-Fu/Photo/Artistic/Wrap Effect..."
    "Draws with wrap effect, which simulates Photoshop's Wrap filter \nfile:iccii-wrap-effect.scm"
