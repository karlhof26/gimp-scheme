...
; version 0.3 by karlhof26 2021/12/17
;     - Modified to work for GIMP 2.10.24+; 
; --------------------------------------------------------------------
;
...
(define (script-fu-pastel-image-icc
            img
            drawable
            detail
            length
...
(script-fu-register "script-fu-pastel-image-icc"
    "<Toolbox>/Script-Fu/Artistic/Pastel Sketch..."
    "Creates a Pastel image sketch. \nfile: iccii-pastel-image.scm"
